...
class __TwigTemplate_799d128e9e810188be7366fc30362cea617e8817cd6d53ff2a31d99ab4155ab9 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("panier_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["panier"]) || array_key_exists("panier", $context) ? $context["panier"] : (function () { throw new RuntimeError('Variable "panier" does not exist.', 1, $this->source); })()), "id", [], "any", false, false, false, 1)]), "html", null, true);
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('panier_delete', {'id': panier.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ panier.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "panier/_delete_form.html.twig", "C:\\Users\\MSI\\Desktop\\middlefeast\\templates\\panier\\_delete_form.html.twig");
    }
}
